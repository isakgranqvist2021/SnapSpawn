...
export default function CookiePolicy(props: DefaultProps) {
  return (
    <AuthPageContainer title="Cookie Policy" {...props}>
      <div className="p-5 flex flex-col gap-5 max-w-prose">
        <section>
          <h1 className="text-2xl font-bold">
            Cookie Policy for aiportraitstudio
          </h1>

          <p>
            This is the Cookie Policy for aiportraitstudio, accessible from{' '}
            <Link
              className="link"
              href="https://aiportraitstudio.com/cookie-policy"
            >
              https://aiportraitstudio.com/cookie-policy
            </Link>
          </p>
        </section>
